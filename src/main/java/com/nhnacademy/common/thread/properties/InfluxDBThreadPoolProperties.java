...
/**
 * InfluxDB 전용 Thread Pool의 실행 파라미터를 외부 설정 파일(application.yml 등)로부터 주입받아 관리하는 클래스입니다.
 * <p>
 ...
 * @see ThreadPoolConfig#influxDBExecutor()
 */
@Getter
@Setter
@Component
@ConfigurationProperties(prefix = "thread-pool.influxdb")
public final class InfluxDBThreadPoolProperties {
     ...
     * <b>Default</b>: 5
     *
     * @see InfluxDBThreadPoolProperties#corePoolSize
     */
